...
from utils.dataloader_care_train import DatasetFromFolder3D as DatasetFromFolder3D_train
...
from utils.dataloader_care_train import apply_affine
...
class BRBS(object):
    ...
    def train_iterator(self, labed_img, labed_lab, unlabed_img1, unlabed_img2):
        ...
        # (1-beta)*l + beta*w1
        # new_lab = (1 - beta) * labed_lab + beta * w_u_to_l
...
if __name__ == '__main__': 
    ...
    RSTNet = BRBS(n_classes=2,epoches=500, iters=200, batch_size=1,
                #  labeled_dir='E:/Data/_DB-Liver/LiQA_training_data/labeled/',
                #  unlabeled_dir='E:/Data/_DB-Liver/LiQA_training_data/unlabeled/', # data loading setting is in the dataloader directly, see models/dataloader_care_train.py
